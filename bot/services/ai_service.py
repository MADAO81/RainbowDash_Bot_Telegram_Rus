...
Автор: MADAO81
Версия: 1.4 — добавлена поддержка пасхалки создателя
"""
...
async def get_rainbow_response(
    ...
    try:
        ...
        # Добавляем особую инструкцию для создателя (пасхалка)
        if is_creator and creator_instruction:
            system_prompt += creator_instruction
            logger.info("👨‍💻 Пасхалка создателя активирована!")
