"""
Планировщик напоминаний для бота Рэйнбоу Дэш.
    ...
    try:
        ...
        for reminder in due_reminders:
            try:
                ...
                clean_text = text.replace("@rainbowdash_rus_bot", "").strip()

                response = (
                    f"🌈 *Напоминание от Рэйнбоу Дэш!*\n\n"
                    f"⚡ Ты просил(а) напомнить:\n"
                    f"{clean_text}\n\n"
                    f"🤘 Не тормози — сделай это прямо сейчас! 💪"
                )
